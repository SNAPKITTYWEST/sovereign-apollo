...
export const enum Opcode {
  TC = 0o00, // Transfer Control
  CCS = 0o01, // Count, Compare, Skip
  INDEX = 0o02,
  XCH = 0o03,
  CS = 0o04,
  TS = 0o05,
  AD = 0o06,
  MASK = 0o07, // AND (needs EXTEND for some)
}

export const enum ExtOpcode {
  READ = 0o00,
  WRITE = 0o01,
  DAS = 0o02,
  LXCH = 0o03,
...
export interface Instruction {
  ...
  opcode: number;
  isExtracode: boolean;
  qc: number; // quarter code
  raw: number; // 15-bit word (parity stripped)
}

export const MCT_US = 11.7; // DOCUMENTED

export const TIMING_MCT: Record<string, number> = {
  TC: 1,
  CCS: 2,
  INDEX: 2,
  XCH: 2,
...
export const FLAGWORDS: Record<string, { word: number; bit: number }> = {
