...
describe("AGC ISA DOCUMENTED", () => {
    ...
    it("Throttle invariant during P63", () => {
        const s = { met: "102:33:05", metSeconds: 0, guidanceMode: "P63", propulsion: { throttle: 1.5 }, vehicle: "PDI", massKg: 5000, dryMassKg: 4000, position: [0, 0, 0], velocity: [0, 0, 0], cdu: [0, 0, 0] };
        expect(() => assertInvariant(s)).toThrow();
        s.propulsion.throttle = 0.5;
        expect(() => assertInvariant(s)).not.toThrow();
    });
});
//# sourceMappingURL=agc.test.js.map