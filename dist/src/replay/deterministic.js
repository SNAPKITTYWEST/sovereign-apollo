...
export class DeterministicReplay {
    ...
    step() {
        ...
        this.hash = h;
        const f = { state: s, telemetry: tel, crewProc: s.alarm ?? "", groundEvent: s.alarm, hash: h };
        this.log.push(f);
        return f;
    }
    replayAll() {
    ...
    static verifyDeterminism(path = "data/mission_timeline.json") {
